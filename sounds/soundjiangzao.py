...
#================1.原始音频信号,时域信息=================================
sameple_rate,sigss = wf.read('C:/Users/zhangming/Desktop/互联网大赛/48.wav')
sigs = sigss[:,0]
...
plt.grid(linestyle=':')
plt.plot(times[:178000],sigs[:178000],color='dodgerblue',label='Noised Signal')
plt.legend()
...
plt.ylabel('Signal',fontsize=12)
plt.grid(linestyle=':')
plt.plot(times[:178000],filter_sigs[:178000],color='dodgerblue',label='Filter Signal')
plt.legend()

#重新生成音频文件
filter_sigs = (filter_sigs*(2**15)).astype('i2')
wf.write('C:/Users/zhangming/Desktop/互联网大赛/filter222.wav',sameple_rate,filter_sigs)
